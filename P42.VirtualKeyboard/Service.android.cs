...
internal class RootLayoutListener : Java.Lang.Object, ViewTreeObserver.IOnGlobalLayoutListener
{
    //int[] _discrepancy = { 0 };
    ...
    private Java.Lang.Ref.WeakReference _displayMetricsReference;

    private Android.Util.DisplayMetrics DisplayMetrics
    {
        get
        {
            _displayMetricsReference ??= new Java.Lang.Ref.WeakReference(Application.Context.Resources.DisplayMetrics);
            var displayMetrics = (Android.Util.DisplayMetrics)_displayMetricsReference.Get();
            if (displayMetrics == null)
            {
                displayMetrics = Application.Context.Resources.DisplayMetrics;
